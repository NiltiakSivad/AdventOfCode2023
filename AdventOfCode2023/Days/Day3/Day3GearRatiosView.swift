...
protocol Day3GearRatiosViewDelegate {
        ...
        List {
            Section {
                ...
                VStack {
                    ...
                    Spacer()
                    Text("You turn around to see a slightly-greasy Elf with a wrench and a look of surprise. 'Sorry, I wasn't expecting anyone! The gondola lift isn't working right now; it'll still be a while before I can fix it.' You offer to help.")
                    
                    Spacer()
                    Text("The engine schematic (your puzzle input) consists of a visual representation of the engine. There are lots of numbers and symbols you don't really understand, but apparently any number adjacent to a symbol, even diagonally, is a 'part number' and should be included in your sum. (Periods (.) do not count as a symbol.) What is the sum of all of the part numbers in the engine schematic?").bold().italic()
                    Spacer()
